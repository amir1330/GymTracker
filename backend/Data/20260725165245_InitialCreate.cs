    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    RestTimerEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    DefaultRestTimeSeconds = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PresetExercises", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PresetExercises_Exercises_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PresetExercises_Presets_PresetId",
                        column: x => x.PresetId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PresetExercises_ExerciseId",
                table: "PresetExercises",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_PresetExercises_PresetId",
                table: "PresetExercises",
                column: "PresetId");
