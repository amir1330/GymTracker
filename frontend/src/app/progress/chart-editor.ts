...
import { ExerciseService, Exercise } from '../exercises/exercise.service';
...
export class ChartEditor implements OnInit, OnChanges {
  ...
  metrics = [
    ...
    { value: 'est1rm', label: 'Est. 1RM', needsExercise: true, allOption: false },
    { value: 'reps', label: 'Reps', needsExercise: true, allOption: false },
  ...
  private loadPreview(): void {
    ...
    this.dashboardService.getChartData(this.metric, exerciseId, this.period).subscribe({
      next: (data) => {
